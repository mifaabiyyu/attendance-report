<x-guest-layout>
  <x-slot name="title">Login User</x-slot>
    <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          ...
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="row mt-3 mb-4 mr-4">
              <div class="col-6 text-right">
                <h4 href="#" class="text-primary"><small>Don't have an account?</small></h4>
              </div>
              <div class="col-6 text-right">
                <a href="{{ route('register')}}" class="text-primary"><small>Create new account</small></a>
              </div>
            </div>
          </div>
        </div>
